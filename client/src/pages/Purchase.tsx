...
import { Plus, Search, CheckCircle, Package, Trash2 } from "lucide-react";
...
const purchaseOrderSchema = z.object({
  supplierId: z.string().min(1, "Борлуулагч сонгоно уу"),
...
const getStatusBadge = (status: string) => {
  switch (status) {
    ...
    case "confirmed": return <Badge className="bg-blue-100 text-blue-800">Баталгаажсан</Badge>;
...
export default function Purchase() {
  const { orders = [], isLoading, createOrder, confirmOrder, receiveOrder } = usePurchaseOrders();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Худалдан авах захиалга, ханган нийлүүлэгчид
          </p>
        </div>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Хүлээгдэж буй огноо</TableHead>
            ...
            {isLoading ? (
              ...
              filteredOrders.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell>{order.expectedDate ? format(new Date(order.expectedDate), "yyyy-MM-dd") : "-"}</TableCell>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Борлуулагч *</FormLabel>
